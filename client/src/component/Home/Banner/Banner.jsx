        ...
        <div className="hero-banner">
            <div className="content">
                <div className="text-content">
                    <h1>JAWAHAR LAL</h1>
                    <p style={{ color: 'white' }}>
                    मेरा नाम जवाहरलाल प्रजापति है और मैं एक हर्बल नुट्रिशन हूँ अगर आप अपना वजन कम करना चाहते है तो इसके साथ-साथ आप बिज़नेस करना चाहते है तो मुझे WhatsApp पर मैसेज में Yess लिखे 

                    </p>
                    <div className="ctas">
                    <a href="/about"><div className="banner-cta">About Me</div></a>
                    <a href="https://wa.me/+919825554062" target="_blank" rel="noopener noreferrer">
  <div class="wApp"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 258">
